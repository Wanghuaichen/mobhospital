...
public class RayBeamMenu extends RelativeLayout {
	private RayLayout mRayLayout;

	private ImageView mHintView;

	public RayBeamMenu(Context context) {
		super(context);
		init(context);
	}

	public RayBeamMenu(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
	...
	private OnClickListener getItemClickListener(final OnClickListener listener) {
		return new OnClickListener() {
			...
			public void onClick(final View viewClicked) {
				...
				if (listener instanceof OnRayItemClickListener) {
					return;
				}
