...
function updateSubMenuByZhuyuanIDforYishi()
{
		...
		temp_sub_menu[continue_number] = new Array();
			...
			temp_sub_menu[continue_number][2] = "/tiantan_emr/Common/HuliJilu/showJilu/type/一般护理/zhuyuan_id/"+current_zhixing_id;
		...
		temp_sub_menu[continue_number+1] = new Array();
			temp_sub_menu[continue_number+1][0] = "体征记录";
			temp_sub_menu[continue_number+1][1] = "tizhengjilu";
			temp_sub_menu[continue_number+1][2] = "/tiantan_emr/TiwenJiludan/showOneweek/zhuyuan_id/"+current_zhixing_id;
			temp_sub_menu[continue_number+1][3] = new Array();

		temp_sub_menu[continue_number+2] = new Array();
			temp_sub_menu[continue_number+2][0] = "三测单";
			temp_sub_menu[continue_number+2][1] = "sancedan";
			temp_sub_menu[continue_number+2][2] = "/tiantan_emr/Common/TiwenJiludan/showList/zhuyuan_id/"+current_zhixing_id;
			temp_sub_menu[continue_number+2][3] = new Array();

		temp_sub_menu[continue_number+3] = new Array();
			temp_sub_menu[continue_number+3][0] = "住院费用";
			temp_sub_menu[continue_number+3][1] = "zhuyuan_feiyong";
			temp_sub_menu[continue_number+3][2] = "/tiantan_emr/Common/Feiyong/editZhuyuanFeiyong/zhuyuan_id/"+current_zhixing_id;
			temp_sub_menu[continue_number+3][3] = new Array();
			
		temp_sub_menu[continue_number+4] = new Array();
			temp_sub_menu[continue_number+4][0] = "健康分析";
			temp_sub_menu[continue_number+4][1] = "jiankang_fenxi";
			temp_sub_menu[continue_number+4][2] = "/tiantan_emr/Common/DataAnalysis/showLineChartPlot/zhuyuan_id/"+current_zhixing_id;
			temp_sub_menu[continue_number+4][3] = new Array();

		temp_sub_menu[continue_number+5] = new Array();
			temp_sub_menu[continue_number+5][0] = "病历质控";
			temp_sub_menu[continue_number+5][1] = "bingli_zhikong";
			temp_sub_menu[continue_number+5][2] = "/tiantan_emr/Zhikong/BingliPingfen/showPingfen/zhuyuan_id/"+current_zhixing_id;
			temp_sub_menu[continue_number+5][3] = new Array();
...
function updateSubMenuByZhuyuanIDforHushi()
{
		...
		temp_sub_menu[0] = new Array();
			temp_sub_menu[0][0] = "患者概览";
			temp_sub_menu[0][1] = "huanzhe_gailan";
			temp_sub_menu[0][2] = "/tiantan_emr/ZhuyuanYishi/Patient/showPatientZhuyuanDetail//zhuyuan_id/"+current_zhixing_id;
			temp_sub_menu[0][3] = new Array();

		temp_sub_menu[1] = new Array();
			temp_sub_menu[1][0] = "护理记录";
			temp_sub_menu[1][1] = "huli_jilu";
			temp_sub_menu[1][2] = "/tiantan_emr/Common/HuliJilu/showJilu/type/一般护理/zhuyuan_id/"+current_zhixing_id;
			temp_sub_menu[1][3] = new Array();
				temp_sub_menu[1][3][0] = new Array();
				temp_sub_menu[1][3][0][0] = "护理管理";
				temp_sub_menu[1][3][0][1] = "yiban_huli_jilu";
				temp_sub_menu[1][3][0][2] = "/tiantan_emr/Common/HuliJilu/editZongjie/zhuyuan_id/"+current_zhixing_id;

		temp_sub_menu[2] = new Array();
			temp_sub_menu[2][0] = "体征记录";
			temp_sub_menu[2][1] = "tizhengjilu";
			temp_sub_menu[2][2] = "/tiantan_emr/TiwenJiludan/showOneweek/zhuyuan_id/"+current_zhixing_id;
			temp_sub_menu[2][3] = new Array();

		temp_sub_menu[3] = new Array();
			temp_sub_menu[3][0] = "三测单";
			temp_sub_menu[3][1] = "sancedan";
			temp_sub_menu[3][2] = "/tiantan_emr/Common/TiwenJiludan/showList/zhuyuan_id/"+current_zhixing_id;
			temp_sub_menu[3][3] = new Array();
	
		temp_sub_menu[4] = new Array();
			temp_sub_menu[4][0] = "住院费用";
			temp_sub_menu[4][1] = "zhuyuan_feiyong";
			temp_sub_menu[4][2] = "/tiantan_emr/Common/Feiyong/editZhuyuanFeiyong/zhuyuan_id/"+current_zhixing_id;
			temp_sub_menu[4][3] = new Array();
		
		temp_sub_menu[5] = new Array();
			temp_sub_menu[5][0] = "健康分析";
			temp_sub_menu[5][1] = "jiankang_fenxi";
			temp_sub_menu[5][2] = "/tiantan_emr/Common/DataAnalysis/showLineChartPlot/zhuyuan_id/"+current_zhixing_id;
			temp_sub_menu[5][3] = new Array();

		main_menu_info[1][2] = "/tiantan_emr/Common/TiwenJiludan/showAddTiwendan/zhuyuan_id/"+current_zhixing_id;
