...
public class JianchaListFragment extends Fragment {
	private View view;
	...
	private List<Map<String, Object>> jianchalistData;
	private JianyanJianchaListAdapter dataAdapter;
	private boolean clickState = false;
	private String initEndDateTime = "2014-08-23"; // 初始化结束时间

	public static JianchaListFragment newInstance() {
		JianchaListFragment fragment1 = new JianchaListFragment();
		return fragment1;
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.jiancha_list, container,
				false);
	...
	private void viewInit() {
		...
		ArrayAdapter<String> jianchazhuangtai_spinnerAdapter = new ArrayAdapter<String>(getActivity(),
				android.R.layout.simple_list_item_1, spinner_zhuangtai);
		spinner_jiancha_zhuangtai.setAdapter(jianchazhuangtai_spinnerAdapter);
	...
	private void getData(String url, final Map<String, String> map) {
		...
		new HttpHelper(getActivity(), new IHandleHttpHelperResult() {
			...
			public void handleResult(final List<Map<String, Object>> httpdata) {
				listData = httpdata;
				jianchalistData = new ArrayList<Map<String, Object>>();
				for (int i = 0; i < listData.size(); i++) {
					jianchalistData.add(listData.get(i));
					dataAdapter = new JianyanJianchaListAdapter(
							jianchalistData, getActivity());
					...
					listView.setOnItemClickListener(new OnItemClickListener() {
						...
						public void onItemClick(AdapterView<?> arg0, View arg1,
								int arg2, long arg3) {
							// TODO Auto-generated method stub
							shenqing_time = listData.get(arg2)
							...
							hospital_name = listData.get(arg2)
									.get("hospital_name").toString();
							jiancha_keshi_name = listData.get(arg2)
	...
	public void goJianyanReport() {
		...
		fragmentTransaction.replace(R.id.contentView, JianchaReport, "left");
