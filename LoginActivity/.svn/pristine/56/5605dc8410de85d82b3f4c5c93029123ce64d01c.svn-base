	...
	function icon_click(click_id){
		...
		switch (click_id)
		{
			case "menu_left_bingli":{
				$("#conframe").attr("src","/tiantan_emr/ZhuyuanYishi/Bingli/bingchengJiluShowList/show_type/bingcheng/zhuyuan_id/"+current_zhixing_id);
...
function updateSubMenuByZhuyuanIDforYishi()
{
		...
		*/
		...
		temp_sub_menu_linchuang[continue_number_linchuang] = new Array();
			...
			temp_sub_menu_linchuang[continue_number_linchuang][2] = "/tiantan_emr/Common/EmrProcess/getContent/bingli_type/住院/bingli_sub_type/病程记录/zhixing_type/住院/zhixing_id/"+current_zhixing_id;
			temp_sub_menu_linchuang[continue_number_linchuang][3] = new Array();
				temp_sub_menu_linchuang[continue_number_linchuang][3][0] = new Array();
					temp_sub_menu_linchuang[continue_number_linchuang][3][0][0] = "入院记录";
					temp_sub_menu_linchuang[continue_number_linchuang][3][0][1] = "ruyuan_jilu";
					temp_sub_menu_linchuang[continue_number_linchuang][3][0][2] = "/tiantan_emr/Common/EmrProcess/getContent/bingli_type/住院/bingli_sub_type/入院记录/zhixing_type/住院/zhixing_id/"+current_zhixing_id;
				temp_sub_menu_linchuang[continue_number_linchuang][3][1] = new Array();
					temp_sub_menu_linchuang[continue_number_linchuang][3][1][0] = "病程记录";
					temp_sub_menu_linchuang[continue_number_linchuang][3][1][1] = "bingcheng_jilu_small";
					temp_sub_menu_linchuang[continue_number_linchuang][3][1][2] = "/tiantan_emr/Common/EmrProcess/getContent/bingli_type/住院/bingli_sub_type/病程记录/zhixing_type/住院/zhixing_id/"+current_zhixing_id;
		continue_number_linchuang ++;
...
function updateSubMenuByMenzhenIDforYishi()
{
		...
		temp_sub_menu[1][0] = "预&nbsp;&nbsp;诊";
		temp_sub_menu[1][1] = "yuanzhen_guanli";
		temp_sub_menu[1][2] = "/tiantan_emr/MenzhenYishi/Bingli/showZhongyiLiangbiaoList/menzhen_id/"+current_zhixing_id;
		temp_sub_menu[1][3] = new Array();
		
		temp_sub_menu[2] = new Array();
		temp_sub_menu[2][0] = "诊&nbsp;&nbsp;断";
		temp_sub_menu[2][1] = "zhenduan";
		temp_sub_menu[2][2] = "/tiantan_emr/MenzhenYishi/Zhenduan/showMenzhenZhenduan/zhixing_type/门诊/zhixing_id/"+current_zhixing_id;
		temp_sub_menu[2][3] = new Array();

		temp_sub_menu[3] = new Array();
		temp_sub_menu[3][0] = "病&nbsp;&nbsp;历";
		temp_sub_menu[3][1] = "bingli_guanli";
		...
		temp_sub_menu[4][0] = "检验检查";
		temp_sub_menu[4][1] = "fuzhu_jiancha";
		temp_sub_menu[4][2] = "/tiantan_emr/MenzhenYishi/Jiancha/showZongjie/menzhen_id/"+current_zhixing_id;
		temp_sub_menu[4][3] = new Array();
				temp_sub_menu[4][3][0] = new Array();
					temp_sub_menu[4][3][0][0] = "添加检查";
					temp_sub_menu[4][3][0][1] = "tianjia_jiancha";
					temp_sub_menu[4][3][0][2] = "/tiantan_emr/MenzhenYishi/Jiancha/showAddJiancha/menzhen_id/"+current_zhixing_id;
				temp_sub_menu[4][3][1] = new Array();
					temp_sub_menu[4][3][1][0] = "查看检查";
					temp_sub_menu[4][3][1][1] = "chakan_jiancha";
					temp_sub_menu[4][3][1][2] = "/tiantan_emr/MenzhenYishi/Jiancha/showList/menzhen_id/"+current_zhixing_id;

		temp_sub_menu[5] = new Array();
		temp_sub_menu[5][0] = "处方管理";
		...
		temp_sub_menu[6][0] = "模板管理";
		temp_sub_menu[6][1] = "muban_guanli";
		temp_sub_menu[6][2] = "/tiantan_emr/Muban/DianxingBingli/showZongjie";
		temp_sub_menu[6][3] = new Array();
				temp_sub_menu[6][3][0] = new Array();
					temp_sub_menu[6][3][0][0] = "模板列表";
					temp_sub_menu[6][3][0][1] = "mubanlist";
					temp_sub_menu[6][3][0][2] = "/tiantan_emr/Muban/DianxingBingli/showMubanList";
				temp_sub_menu[6][3][1] = new Array();
					temp_sub_menu[6][3][1][0] = "添加模板";
					temp_sub_menu[6][3][1][1] = "addmuban";
					temp_sub_menu[6][3][1][2] = "/tiantan_emr/Muban/DianxingBingli/editMuban/save_type/add";
...
function loadYishengConfig()
{
	...
	main_menu_info[3][2] = "/tiantan_emr/Common/EmrProcess/getContent/bingli_type/住院/bingli_sub_type/病程记录/zhixing_type/住院";
