...
function updateSubMenuByZhuyuanIDforHushi()
{
		...
		temp_sub_menu_huli[continue_number_huli] = new Array();
			...
			temp_sub_menu_huli[continue_number_huli][3] = new Array();
				...
				temp_sub_menu_huli[continue_number_huli][3][2] = new Array();
					temp_sub_menu_huli[continue_number_huli][3][2][0] = "护理文书列表";
					temp_sub_menu_huli[continue_number_huli][3][2][1] = "huli_wenshu_list";
					temp_sub_menu_huli[continue_number_huli][3][2][2]  = "/tiantan_emr/ZhuyuanHushi/HuliWenshu/showList/zhuyuan_id/"+current_zhixing_id;
		continue_number_huli++;
		...
		// if(user_department_position=="护士长")
		// {
			temp_sub_menu_huli[continue_number_huli] = new Array();
			temp_sub_menu_huli[continue_number_huli][0] = "护理统计";
			temp_sub_menu_huli[continue_number_huli][1] = "huli_tongji";
			temp_sub_menu_huli[continue_number_huli][2] = "/tiantan_emr/ZhuyuanHushi/HuliTongji/showKeshiTongji";
			temp_sub_menu_huli[continue_number_huli][3] = new Array();
					temp_sub_menu_huli[continue_number_huli][3][0] = new Array();
					temp_sub_menu_huli[continue_number_huli][3][0][0] = "科室工作量";
					temp_sub_menu_huli[continue_number_huli][3][0][1] = "keshi_tongji";
					temp_sub_menu_huli[continue_number_huli][3][0][2]  = "/tiantan_emr/ZhuyuanHushi/HuliTongji/showKeshiTongji";
				temp_sub_menu_huli[continue_number_huli][3][1] = new Array();
					temp_sub_menu_huli[continue_number_huli][3][1][0] = "个人工作量";
					temp_sub_menu_huli[continue_number_huli][3][1][1] = "geren_tongji";
					temp_sub_menu_huli[continue_number_huli][3][1][2]  = "/tiantan_emr/ZhuyuanHushi/HuliTongji/showGerenTongji";
				temp_sub_menu_huli[continue_number_huli][3][2] = new Array();
				temp_sub_menu_huli[continue_number_huli][3][2][0] = "工作量详细";
				temp_sub_menu_huli[continue_number_huli][3][2][1] = "tongji_detail";
				temp_sub_menu_huli[continue_number_huli][3][2][2]  = "/tiantan_emr/ZhuyuanHushi/HuliTongji/showTongjiDetail";
			continue_number_huli++;
		// }
       var d=new Date();
       var day=d.getDate();
       ...
       if(day<10)
		...
		/* temp_sub_menu_huli[continue_number_huli] = new Array();
			temp_sub_menu_huli[continue_number_huli][0] = "交班记录";
			temp_sub_menu_huli[continue_number_huli][1] = "jiaoban_jilu";
			temp_sub_menu_huli[continue_number_huli][2] = "/tiantan_emr/ZhuyuanHushi/JiaobanJilu/showJilu/date/"+date+"/user_department/"+user_department;
			temp_sub_menu_huli[continue_number_huli][3] = new Array();
		continue_number_huli++; */
		...
		refreshSubMultiMenu(temp_sub_menu_bingli,temp_sub_menu_huli,temp_sub_menu_linchuang);
		//refreshSubMenu(temp_sub_menu);
}
...
function loadHushiConfig()
{
	...
	main_menu_info[1][0] = "医嘱执行";
	main_menu_info[1][1] = "yizhuzhixing";
	main_menu_info[1][2] = "/tiantan_emr/Common/Yizhuguanli/showYizhuZhixing/user_department/"+user_department+"/geiyao_fangshi/输液/yizhu_leixing/长期";
	main_menu_info[1][3] = "医嘱执行";
	main_menu_info[1][4] = new Array();
