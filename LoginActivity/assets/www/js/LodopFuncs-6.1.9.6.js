...
**************************/
	...
	try{	
		...
		// LODOP.SET_LICENSES("北京天坦呵呵软件有限责任公司","653687367698075919295898093190","","");
		LODOP.SET_LICENSES("(中国)移动护士工作站","93F6ED3BD0A7BDEE5148962B021849AC","","");
	     //============================================================	     
	     return LODOP; 
	} catch(err) {
	     if (is64IE)	
...
function setPrinter(printer_name)
{
	...
	{
		printer_name_i = LODOP.GET_PRINTER_NAME(i);
		if(printer_name_i == printer_name)
		{
			printer_id = i;
			LODOP.SET_PRINTER_INDEXA(printer_name_i);
			break;
		}
	}
