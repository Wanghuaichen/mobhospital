...
$(document).ready(function(){
	...
	if(user_type=="医生")
		...
		loadBingAnConfig();
	else if(user_type=="科室质控")
		loadKeShiZhikongConfig();
	else if(user_type=="医务质控")
		loadYiWuZhikongConfig();		
...
function analysisUrl(current_content_url)
{
	...
	if (current_content_url.indexOf("tiantan_add_form") == -1 && (current_content_url.indexOf("/edit") == -1||current_content_url.indexOf("Jiancha/edit") != -1))
	{
		...
		else
		{
			...
			else if (current_url.indexOf("biaozhunBingli") != -1)
				printer_url = current_content_url.replace("biaozhunBingli", "printbiaozhunBingli");
		...
		if (current_content_url.indexOf("BingliGuanli/bingliXujie") != -1)
		{
			printer_url = "";
		}
		//alert(current_url);
	...
	//如果因为进入了护理管理功能
	if(current_content_url.indexOf("###")==-1 && current_content_url.indexOf("ZhuyuanHushi/HuliGuanli/showAllHushiInfo")!=-1)
	{
...
function updateSubMenuByZhikongIDforZhikong()
{
	$(".left_menu_title").html("当前病历："+current_patient_xingming);
		...
		if(chuyuan_type !='住院中')
		{
			...
			temp_sub_menu[11][0] = "质控汇总";
			temp_sub_menu[11][1] = "zhikong_huizong";
			temp_sub_menu[11][2] = "/tiantan_emr/Zhikong/BingliPingfen/showPingfenHuizong/";
			temp_sub_menu[11][3] = new Array();
		}
		else
		{
		 	temp_sub_menu[10] = new Array();
			temp_sub_menu[10][0] = "质控汇总";
			temp_sub_menu[10][1] = "zhikong_huizong";
			temp_sub_menu[10][2] = "/tiantan_emr/Zhikong/BingliPingfen/showPingfenHuizong/";
			temp_sub_menu[10][3] = new Array();				
		}
...
function updateJieyueSubMenuByZhuyuanIDforYishi()
{
		...
		if(jieyue_fanwei.indexOf("|7|")!=-1)
		{
			temp_sub_menu_linchuang[continue_number_linchuang] = new Array();
				temp_sub_menu_linchuang[continue_number_linchuang][0] = "住院信息总览";
				temp_sub_menu_linchuang[continue_number_linchuang][1] = "zhuyuan_xinxi_zonglan";
				temp_sub_menu_linchuang[continue_number_linchuang][2] = "/tiantan_emr/ZhuyuanYishi/Patient/showPatientZhuyuanDetail/zhuyuan_id/"+current_zhixing_id;
				temp_sub_menu_linchuang[continue_number_linchuang][3] = new Array();
			continue_number_linchuang++;
		}
		/*
...
function updateSubMenuByZhuyuanIDforHushi()
{
		...
		temp_sub_menu_linchuang[continue_number_linchuang] = new Array();
			temp_sub_menu_linchuang[continue_number_linchuang][0] = "患者概览";
			temp_sub_menu_linchuang[continue_number_linchuang][1] = "zhuyuan_xinxi_zonglan";
			temp_sub_menu_linchuang[continue_number_linchuang][2] = "/tiantan_emr/ZhuyuanYishi/Patient/showPatientZhuyuanDetail/zhuyuan_id/"+current_zhixing_id;
			temp_sub_menu_linchuang[continue_number_linchuang][3] = new Array();
		continue_number_linchuang++;
		...
		if(bingli_operate_authority=="zll")
		{
			temp_sub_menu_bingli[continue_number_bingli] = new Array();
				...
				temp_sub_menu_bingli[continue_number_bingli][2] = "/tiantan_emr/TiantanBingliEditor/showBingliList/zhixing_type/住院/bingli_type/护理/zhixing_id/"+current_zhixing_id;
				temp_sub_menu_bingli[continue_number_bingli][3] = new Array();
					temp_sub_menu_bingli[continue_number_bingli][3][0] = new Array();
						temp_sub_menu_bingli[continue_number_bingli][3][0][0] = "护理记录";
						temp_sub_menu_bingli[continue_number_bingli][3][0][1] = "huli_pinggudan";
						temp_sub_menu_bingli[continue_number_bingli][3][0][2]  = "/tiantan_emr/TiantanBingliEditor/showBingliList/zhixing_type/住院/bingli_type/护理/bingli_sub_type/护理记录/zhixing_id/"+current_zhixing_id;
					temp_sub_menu_bingli[continue_number_bingli][3][1] = new Array();
						temp_sub_menu_bingli[continue_number_bingli][3][1][0] = "评估单";
						temp_sub_menu_bingli[continue_number_bingli][3][1][1] = "jiankang_xuanjiao";
						temp_sub_menu_bingli[continue_number_bingli][3][1][2]  = "/tiantan_emr/TiantanBingliEditor/showBingliList/zhixing_type/住院/bingli_type/护理/bingli_sub_type/评估单/zhixing_id/"+current_zhixing_id;
					temp_sub_menu_bingli[continue_number_bingli][3][2] = new Array();
						temp_sub_menu_bingli[continue_number_bingli][3][2][0] = "宣教单";
						temp_sub_menu_bingli[continue_number_bingli][3][2][1] = "huli_wenshu_list";
						temp_sub_menu_bingli[continue_number_bingli][3][2][2]  = "/tiantan_emr/TiantanBingliEditor/showBingliList/zhixing_type/住院/bingli_type/护理/bingli_sub_type/宣教单/zhixing_id/"+current_zhixing_id;
					temp_sub_menu_bingli[continue_number_bingli][3][3] = new Array();
						temp_sub_menu_bingli[continue_number_bingli][3][3][0] = "监测单";
						temp_sub_menu_bingli[continue_number_bingli][3][3][1] = "huli_wenshu_list1";
						temp_sub_menu_bingli[continue_number_bingli][3][3][2]  = "/tiantan_emr/TiantanBingliEditor/showBingliList/zhixing_type/住院/bingli_type/护理/bingli_sub_type/监测单/zhixing_id/"+current_zhixing_id;
					temp_sub_menu_bingli[continue_number_bingli][3][4] = new Array();
						temp_sub_menu_bingli[continue_number_bingli][3][4][0] = "其它护理文书";
						temp_sub_menu_bingli[continue_number_bingli][3][4][1] = "huli_wenshu_list1";
						temp_sub_menu_bingli[continue_number_bingli][3][4][2]  = "/tiantan_emr/TiantanBingliEditor/showBingliList/zhixing_type/住院/bingli_type/护理/bingli_sub_type/其它护理文书/zhixing_id/"+current_zhixing_id;
			continue_number_bingli++;
		}
		else
		{
			temp_sub_menu_bingli[continue_number_bingli] = new Array();
				...
				temp_sub_menu_bingli[continue_number_bingli][2] = "/tiantan_emr/HuliJilu/showList/zhuyuan_id/"+current_zhixing_id;
				temp_sub_menu_bingli[continue_number_bingli][3] = new Array();
					temp_sub_menu_bingli[continue_number_bingli][3][0] = new Array();
					temp_sub_menu_bingli[continue_number_bingli][3][0][0] = "护理管理";
					temp_sub_menu_bingli[continue_number_bingli][3][0][1] = "yiban_huli_jilu";
					temp_sub_menu_bingli[continue_number_bingli][3][0][2] = "/tiantan_emr/Common/HuliJilu/editZongjie/zhuyuan_id/"+current_zhixing_id;
			continue_number_bingli++;
			...
			temp_sub_menu_bingli[continue_number_bingli] = new Array();
				temp_sub_menu_bingli[continue_number_bingli][0] = "护理文书";
				temp_sub_menu_bingli[continue_number_bingli][1] = "huli_wenshu";
				temp_sub_menu_bingli[continue_number_bingli][2] = "/tiantan_emr/BingliEditor/showList/zhixing_type/住院/bingli_type/护理/zhuyuan_id/"+current_zhixing_id;
				temp_sub_menu_bingli[continue_number_bingli][3] = new Array();
					temp_sub_menu_bingli[continue_number_bingli][3][0] = new Array();
						temp_sub_menu_bingli[continue_number_bingli][3][0][0] = "护理记录";
						temp_sub_menu_bingli[continue_number_bingli][3][0][1] = "huli_pinggudan";
						temp_sub_menu_bingli[continue_number_bingli][3][0][2]  = "/tiantan_emr/BingliEditor/showList/zhixing_type/住院/bingli_type/护理/bingli_sub_type/护理记录/zhuyuan_id/"+current_zhixing_id;
					temp_sub_menu_bingli[continue_number_bingli][3][1] = new Array();
						temp_sub_menu_bingli[continue_number_bingli][3][1][0] = "评估单";
						temp_sub_menu_bingli[continue_number_bingli][3][1][1] = "jiankang_xuanjiao";
						temp_sub_menu_bingli[continue_number_bingli][3][1][2]  = "/tiantan_emr/BingliEditor/showList/zhixing_type/住院/bingli_type/护理/bingli_sub_type/评估单/zhuyuan_id/"+current_zhixing_id;
					temp_sub_menu_bingli[continue_number_bingli][3][2] = new Array();
						temp_sub_menu_bingli[continue_number_bingli][3][2][0] = "宣教单";
						temp_sub_menu_bingli[continue_number_bingli][3][2][1] = "huli_wenshu_list";
						temp_sub_menu_bingli[continue_number_bingli][3][2][2]  = "/tiantan_emr/BingliEditor/showList/zhixing_type/住院/bingli_type/护理/bingli_sub_type/宣教单/zhuyuan_id/"+current_zhixing_id;
					temp_sub_menu_bingli[continue_number_bingli][3][3] = new Array();
						temp_sub_menu_bingli[continue_number_bingli][3][3][0] = "监测单";
						temp_sub_menu_bingli[continue_number_bingli][3][3][1] = "huli_wenshu_list1";
						temp_sub_menu_bingli[continue_number_bingli][3][3][2]  = "/tiantan_emr/BingliEditor/showList/zhixing_type/住院/bingli_type/护理/bingli_sub_type/监测单/zhuyuan_id/"+current_zhixing_id;
					temp_sub_menu_bingli[continue_number_bingli][3][4] = new Array();
						temp_sub_menu_bingli[continue_number_bingli][3][4][0] = "其它护理文书";
						temp_sub_menu_bingli[continue_number_bingli][3][4][1] = "huli_wenshu_list1";
						temp_sub_menu_bingli[continue_number_bingli][3][4][2]  = "/tiantan_emr/BingliEditor/showList/zhixing_type/住院/bingli_type/护理/bingli_sub_type/其它护理文书/zhuyuan_id/"+current_zhixing_id;
			continue_number_bingli++;
		}
		...
		temp_sub_menu_huli[continue_number_huli] = new Array();
			temp_sub_menu_huli[continue_number_huli][0] = "体征详情";
			temp_sub_menu_huli[continue_number_huli][1] = "tizhengjilu";
		...
		temp_sub_menu_linchuang[continue_number_linchuang] = new Array();
			...
			temp_sub_menu_linchuang[continue_number_linchuang][3] = new Array();
				...
				temp_sub_menu_linchuang[continue_number_linchuang][3][3][0] = "其他医嘱";
				temp_sub_menu_linchuang[continue_number_linchuang][3][3][1] = "linshi_yizhu";
				temp_sub_menu_linchuang[continue_number_linchuang][3][3][2] = "/tiantan_emr/Common/Yizhuguanli/showYizhuZhixing/user_department/"+user_department+"/binglihao/"+current_zhixing_id+"/others"+xingming_url+chuanghao;
				temp_sub_menu_linchuang[continue_number_linchuang][3][4] = new Array();
				temp_sub_menu_linchuang[continue_number_linchuang][3][4][0] = "执行记录";
				temp_sub_menu_linchuang[continue_number_linchuang][3][4][1] = "zhixing_record";
				temp_sub_menu_linchuang[continue_number_linchuang][3][4][2] = "/tiantan_emr/Common/Yizhuguanli/showYizhuDetail/zhuyuan_id/"+current_zhixing_id;
		continue_number_linchuang++;
		if(shifou_zhuyuan_chufang=="on" || zhiliao_leibie!="西医治疗")
		{
			temp_sub_menu_linchuang[continue_number_linchuang] = new Array();
		...
		temp_sub_menu_huli[continue_number_huli] = new Array();
			temp_sub_menu_huli[continue_number_huli][0] = "巡查记录";
			temp_sub_menu_huli[continue_number_huli][1] = "xuncha_jilu";
			temp_sub_menu_huli[continue_number_huli][2] = "/tiantan_emr/ZhuyuanHushi/XunchaJilu/showXunchaJilu/zhuyuan_id/"+current_zhixing_id;
			temp_sub_menu_huli[continue_number_huli][3] = new Array();
				temp_sub_menu_huli[continue_number_huli][3][0] = new Array();
					temp_sub_menu_huli[continue_number_huli][3][0][0] = "巡查统计";
					temp_sub_menu_huli[continue_number_huli][3][0][1] = "xuncha_tongji";
					temp_sub_menu_huli[continue_number_huli][3][0][2]  = "/tiantan_emr/ZhuyuanHushi/XunchaJilu/showXunchaJilu/zhuyuan_id/"+current_zhixing_id;
				temp_sub_menu_huli[continue_number_huli][3][1] = new Array();
					temp_sub_menu_huli[continue_number_huli][3][1][0] = "添加巡查记录";
					temp_sub_menu_huli[continue_number_huli][3][1][1] = "add_xuncha_jilu";
					temp_sub_menu_huli[continue_number_huli][3][1][2]  = "/tiantan_emr/ZhuyuanHushi/XunchaJilu/showAddXunchaJilu/zhuyuan_id/"+current_zhixing_id;
				temp_sub_menu_huli[continue_number_huli][3][2] = new Array();
					temp_sub_menu_huli[continue_number_huli][3][2][0] = "巡查记录详细";
					temp_sub_menu_huli[continue_number_huli][3][2][1] = "xuncha_jilu_detail";
					temp_sub_menu_huli[continue_number_huli][3][2][2]  = "/tiantan_emr/ZhuyuanHushi/XunchaJilu/showXunchaJiluDetail/zhuyuan_id/"+current_zhixing_id;
		continue_number_huli++;

		temp_sub_menu_huli[continue_number_huli] = new Array();
		temp_sub_menu_huli[continue_number_huli][0] = "急诊绿色通道";
		temp_sub_menu_huli[continue_number_huli][1] = "";
		temp_sub_menu_huli[continue_number_huli][2] = "/tiantan_emr/ZhuyuanHushi/XunchaJilu/showJijiuLiucheng/menzhen_id/"+current_zhixing_id;
		temp_sub_menu_huli[continue_number_huli][3] = new Array();
...
function updateSubMenuByMenzhenIDforYishi(liuguan_flag)
{
		...
		temp_sub_menu[continue_number] = new Array();
		temp_sub_menu[continue_number][0] = "急诊绿色通道";
		temp_sub_menu[continue_number][1] = "xuncha_jilu";
		temp_sub_menu[continue_number][2] = "/tiantan_emr/ZhuyuanHushi/XunchaJilu/showJijiuLiucheng/menzhen_id/"+menzhen_zhixing_id;
		temp_sub_menu[continue_number++][3] = new Array();

		// temp_sub_menu[continue_number] = new Array();
		// temp_sub_menu[continue_number][0] = "门急诊诊断";
		...
		// temp_sub_menu[continue_number][3][0] = new Array();
		// temp_sub_menu[continue_number][3][0][0] = "诊断快速录入";
		// temp_sub_menu[continue_number][3][0][1] = "zhenduan_kuaisu";
		// temp_sub_menu[continue_number++][3][0][2] = "/tiantan_emr/MenzhenYishi/Zhenduan/zhenduanKuaisuLuru/zhixing_type/门诊/zhixing_id/"+menzhen_zhixing_id;
		...
		temp_sub_menu[continue_number] = new Array();
		temp_sub_menu[continue_number][0] = "门急诊病历";
		temp_sub_menu[continue_number][1] = "bingli_guanli";
		temp_sub_menu[continue_number][2] = "/tiantan_emr/MenzhenYishi/Bingli/showMenzhenBingli/bingli_type/0/menzhen_id/"+menzhen_zhixing_id;
		temp_sub_menu[continue_number][3] = new Array();
			temp_sub_menu[continue_number][3][0] = new Array();
			temp_sub_menu[continue_number][3][0][0] = "主诉";
			temp_sub_menu[continue_number][3][0][1] = "zhusu";
			temp_sub_menu[continue_number][3][0][2] = "/tiantan_emr/MenzhenYishi/Bingli/bingliZhusu/bingli_type/0/menzhen_id/"+menzhen_zhixing_id;
			temp_sub_menu[continue_number][3][1] = new Array();
			temp_sub_menu[continue_number][3][1][0] = "既往史";
			temp_sub_menu[continue_number][3][1][1] = "jiwangshi";
			temp_sub_menu[continue_number++][3][1][2] = "/tiantan_emr/MenzhenYishi/Bingli/bingliJiwangshi/bingli_type/0/menzhen_id/"+menzhen_zhixing_id;*/
			
		temp_sub_menu[continue_number] = new Array();
		temp_sub_menu[continue_number][0] = "门诊病历";
		temp_sub_menu[continue_number][1] = "bingli_guanli";
		temp_sub_menu[continue_number][2] = "/tiantan_emr/MenzhenYishi/Bingli/showJizhenBingli/menzhen_id/"+menzhen_zhixing_id;
		temp_sub_menu[continue_number++][3] = new Array();
		
		temp_sub_menu[continue_number] = new Array();
		temp_sub_menu[continue_number][0] = "事件补录";
		temp_sub_menu[continue_number][1] = "shijian_bulu";
		temp_sub_menu[continue_number][2] = "/tiantan_emr/MenzhenYishi/Bingli/shijianBulu/menzhen_id/"+menzhen_zhixing_id;
		temp_sub_menu[continue_number++][3] = new Array();
	 ...
	 // 		temp_sub_menu[continue_number++][3][1][2] = "/tiantan_emr/MenzhenYishi/TiwenJiludan/showOneweek/zhixing_id/"+menzhen_zhixing_id;
		...
		//  		temp_sub_menu[continue_number][3][0][0] = "口服医嘱";
		//  		temp_sub_menu[continue_number][3][0][1] = "changqi_yizhu";
		//  		temp_sub_menu[continue_number][3][0][2] = "/tiantan_emr/MenzhenYishi/Yizhuguanli/showYizhuZhixing/user_department/"+user_department+"/binglihao/"+menzhen_zhixing_id+"/geiyao_fangshi/口服";
		//  		temp_sub_menu[continue_number][3][1] = new Array();
		//  		temp_sub_menu[continue_number][3][1][0] = "输液医嘱";
		//  		temp_sub_menu[continue_number][3][1][1] = "linshi_yizhu";
		//  		temp_sub_menu[continue_number][3][1][2] = "/tiantan_emr/MenzhenYishi/Yizhuguanli/showYizhuZhixing/user_department/"+user_department+"/binglihao/"+menzhen_zhixing_id+"/geiyao_fangshi/输液";
		//  		temp_sub_menu[continue_number][3][2] = new Array();
		//  		temp_sub_menu[continue_number][3][2][0] = "中草药医嘱";
		//  		temp_sub_menu[continue_number][3][2][1] = "changqi_yizhu";
		//  		temp_sub_menu[continue_number][3][2][2] = "/tiantan_emr/MenzhenYishi/Yizhuguanli/showYizhuZhixing/user_department/"+user_department+"/binglihao/"+menzhen_zhixing_id+"/geiyao_fangshi/中草药";
		//  		temp_sub_menu[continue_number][3][3] = new Array();
		//  		temp_sub_menu[continue_number][3][3][0] = "其他医嘱";
		//  		temp_sub_menu[continue_number][3][3][1] = "linshi_yizhu";
		//  		temp_sub_menu[continue_number++][3][3][2] = "/tiantan_emr/MenzhenYishi/Yizhuguanli/showYizhuZhixing/user_department/"+user_department+"/binglihao/"+menzhen_zhixing_id+"/geiyao_fangshi/其他";
		// }
		...
		// temp_sub_menu[continue_number] = new Array();
		// temp_sub_menu[continue_number][0] = "评估量表";
		// temp_sub_menu[continue_number][1] = "huli_jilu";
		// temp_sub_menu[continue_number][2] = "/tiantan_emr/MenzhenYishi/Bingli/showLiangbiao/menzhen_id/"+menzhen_zhixing_id;
		// temp_sub_menu[continue_number++][3] = new Array();
		
		
			/*temp_sub_menu[continue_number][3][0] = new Array();
			temp_sub_menu[continue_number][3][0][0] = "急救统计";
			temp_sub_menu[continue_number][3][0][1] = "xuncha_tongji";
			temp_sub_menu[continue_number][3][0][2]  = "/tiantan_emr/ZhuyuanHushi/XunchaJilu/showXunchaJilu/zhuyuan_id/"+menzhen_zhixing_id;
			temp_sub_menu[continue_number][3][1] = new Array();
			temp_sub_menu[continue_number][3][1][0] = "添加急救信息";
			temp_sub_menu[continue_number][3][1][1] = "add_xuncha_jilu";
			temp_sub_menu[continue_number][3][1][2]  = "/tiantan_emr/ZhuyuanHushi/XunchaJilu/showAddXunchaJilu/zhuyuan_id/"+menzhen_zhixing_id;
			temp_sub_menu[continue_number][3][2] = new Array();
			temp_sub_menu[continue_number][3][2][0] = "急救详细记录";
			temp_sub_menu[continue_number][3][2][1] = "xuncha_jilu_detail";
			temp_sub_menu[continue_number][3][2][2]  = "/tiantan_emr/ZhuyuanHushi/XunchaJilu/showXunchaJiluDetail/zhuyuan_id/"+menzhen_zhixing_id;
			temp_sub_menu[continue_number][3][3] = new Array();
			temp_sub_menu[continue_number][3][3][0] = "急救登记表";
			temp_sub_menu[continue_number][3][3][1] = "data_yizhu";
			temp_sub_menu[continue_number++][3][3][2]  = "/tiantan_emr/ZhuyuanHushi/XunchaJilu/showJijiuJilu/zhuyuan_id/"+menzhen_zhixing_id;*/
...
//展览路科室质控管理系统
function loadKeShiZhikongConfig()
{
...
//展览路医务科质控管理系统
function loadYiWuZhikongConfig()
{
	var main_menu_number = 2;
	for(var main_menu_count=0;main_menu_count<main_menu_number;main_menu_count++)
	{
...
function loadMenzhenyishengConfig()
{
	...
	main_menu_info[1][0] = "统计分析";
	main_menu_info[1][1] = "information_statistics";
	main_menu_info[1][2] = "/tiantan_emr/MenzhenYishi/Tongji/menzhenTongji";
	main_menu_info[1][3] = "统计分析";
	main_menu_info[1][4] = new Array();
		main_menu_info[1][4][0] = new Array();
			main_menu_info[1][4][0][0] = "门诊统计";
			main_menu_info[1][4][0][1] = "chuanranbing_shangbao";
			main_menu_info[1][4][0][2] = "/tiantan_emr/MenzhenYishi/Tongji/menzhenTongji";
			main_menu_info[1][4][0][3] = new Array();
		main_menu_info[1][4][1] = new Array();
			main_menu_info[1][4][1][0] = "卒中统计";
			main_menu_info[1][4][1][1] = "add_config";
			main_menu_info[1][4][1][2] = "/tiantan_emr/Zhikong/BingliGuanli/showJizhenTongji";
			main_menu_info[1][4][1][3] = new Array();
		main_menu_info[1][4][2] = new Array();
			main_menu_info[1][4][2][0] = "组织概览";
			main_menu_info[1][4][2][1] = "hushigailan";
			main_menu_info[1][4][2][2] = "/tiantan_emr/ZhuyuanHushi/HuliGuanli/showAllHushiInfo"+"/user_department/"+user_department;
			main_menu_info[1][4][2][3] = new Array();
...
function loadHushiConfig()
{
	...
	main_menu_info[0][0] = "查看患者";
	main_menu_info[0][1] = "show_patient";
	main_menu_info[0][2] = "/tiantan_emr/ZhuyuanYishi/Patient/showPatientList/zhuangtai/住院中/guidang_zhuangtai/未归档/suoyoubingren/suoyou/";
	...
	main_menu_info[3][2] = "/tiantan_emr/Common/Yizhuguanli/showYizhuZhixing/user_department/"+user_department+"/geiyao_fangshi/输液";
...
function loadAdminConfig()
{
	...
	main_menu_info[3][4] = new Array();
		...
		main_menu_info[3][4][6] = new Array();
			main_menu_info[3][4][6][0] = "模板管理";
			main_menu_info[3][4][6][1] = "huliwenshu";
			main_menu_info[3][4][6][2] = "/tiantan_emr/Admin/BingliMubanEditor/showList/muban_type/bingli";
			main_menu_info[3][4][6][3] = new Array();
				main_menu_info[3][4][6][3][0] = new Array();
					main_menu_info[3][4][6][3][0][0] = "病历文书";
					main_menu_info[3][4][6][3][0][1] = "data_xiangmu_pinlv";
					main_menu_info[3][4][6][3][0][2] = "/tiantan_emr/Admin/BingliMubanEditor/showList/muban_type/bingli";
					main_menu_info[3][4][6][3][0][3] = new Array();
				main_menu_info[3][4][6][3][1] = new Array();
					main_menu_info[3][4][6][3][1][0] = "护理文书";
					main_menu_info[3][4][6][3][1][1] = "data_xiangmu_pinlv";
					main_menu_info[3][4][6][3][1][2] = "/tiantan_emr/Admin/BingliMubanEditor/showList/muban_type/huli";
					main_menu_info[3][4][6][3][1][3] = new Array();
				main_menu_info[3][4][6][3][2] = new Array();		
					main_menu_info[3][4][6][3][2][0] = "护理记录";
					main_menu_info[3][4][6][3][2][1] = "huli_jilu_muban";
					main_menu_info[3][4][6][3][2][2] = "/tiantan_emr/Admin/PublicResource/showHulijiluMubanList";
					main_menu_info[3][4][6][3][2][3] = new Array();
				main_menu_info[3][4][6][3][3] = new Array();		
					main_menu_info[3][4][6][3][3][0] = "其它文书";
					main_menu_info[3][4][6][3][3][1] = "zhiqing_tongyishu";
					main_menu_info[3][4][6][3][3][2] = "/tiantan_emr/Admin/PublicResource/showOtherDocumentList";
					main_menu_info[3][4][6][3][3][3] = new Array();
		main_menu_info[3][4][7] = new Array();
			main_menu_info[3][4][7][0] = "数据元管理";
			main_menu_info[3][4][7][1] = "shujuyuan";
			main_menu_info[3][4][7][2] = "/tiantan_emr/Admin/BingliMubanEditor/dataList";
			main_menu_info[3][4][7][3] = new Array();
		main_menu_info[3][4][8] = new Array();
			main_menu_info[3][4][8][0] = "临床路径";
			main_menu_info[3][4][8][1] = "linchuanglujing";
			main_menu_info[3][4][8][2] = "/tiantan_emr/Muban/DianxingBingli/showDianxingBingliList/muban_type/公共模板";
			main_menu_info[3][4][8][3] = new Array();
		main_menu_info[3][4][9] = new Array();
			main_menu_info[3][4][9][0] = "护理文书单元";
			main_menu_info[3][4][9][1] = "huliwenshudanyuan";
			main_menu_info[3][4][9][2] = "/tiantan_emr/Admin/BingliMubanEditor/huliItemList";
			main_menu_info[3][4][9][3] = new Array();
		main_menu_info[3][4][10] = new Array();
			main_menu_info[3][4][10][0] = "护理文书模板";
			main_menu_info[3][4][10][1] = "huliwenshumuban";
			main_menu_info[3][4][10][2] = "/tiantan_emr/Admin/BingliMubanEditor/huliWenshuList";
	...
	for(var main_menu_count=0;main_menu_count<main_menu_number;main_menu_count++)
	{
		...
		$("#"+main_menu_info[main_menu_count][1]+"").click(function(){
			...
			else if($(this).attr("url")=="show_hulijilu")
			{
				if(current_zhixing_id != '')
				{
					var temp_url = "/tiantan_emr/TiantanBingliEditor/showBingliList/zhixing_type/住院/bingli_type/护理/zhixing_id/"+current_zhixing_id;
					window.open(temp_url,'conframe');
				...
				else
				{
					...
					function openOnehulijilu()
					{
						...
						$(".left_menu_div:first").css("color","#FFFFFF");
						var temp_zhuyuan_id = $(".left_menu_div:first").attr("zhuyuanid");
						var bingchengjilu_url = "/tiantan_emr/TiantanBingliEditor/showBingliList/zhixing_type/住院/bingli_type/护理/zhixing_id/"+temp_zhuyuan_id+"#bottom";
						window.open(bingchengjilu_url,'conframe');
					}
				}
			}
