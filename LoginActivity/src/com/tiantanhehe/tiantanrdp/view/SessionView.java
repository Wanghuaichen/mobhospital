...
package com.tiantanhehe.tiantanrdp.view;

import java.util.Stack;

import com.tiantanhehe.tiantanrdp.RdpMainActivity;
import com.tiantanhehe.tiantanrdp.SessionState;
import com.tiantanhehe.tiantanrdp.utils.DoubleGestureDetector;
import com.tiantanhehe.tiantanrdp.utils.GestureDetector;
...
public class SessionView extends View
{
	public interface SessionViewListener {
		...
		abstract void onSessionViewLongClick(int x, int y);
	}
	...
	private static final float TOUCH_SCROLL_DELTA = 5.0f;
	...
	private class SessionGestureListener extends GestureDetector.SimpleOnGestureListener {
        ...
        public void onLongPress(MotionEvent e) {
			...
			sessionViewListener.onSessionViewLongClick((int) e.getX(), (int) e.getY());
        }
	...
	public boolean dispatchKeyEventPreIme(KeyEvent event) {
		if(event.getKeyCode() == KeyEvent.KEYCODE_BACK && event.getAction() == KeyEvent.ACTION_DOWN)
			((RdpMainActivity)this.getContext()).onBackPressed();
