...
public class ColorPickerDialog extends Dialog {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		int height = (int) (manager.getDefaultDisplay().getWidth() * 0.5f * scale);
	...
	private class ColorPickerView extends View {
		...
		public ColorPickerView(Context context, int height, int width) {
			...
			// 渐变色环参数
			mCircleColors = new int[] { 0xFFFF0000, 0xFFFF00FF, 0xFF0000FF, 0xFF00FFFF, 0xFF00FF00, 0xFFFFFF00,
					0xFFFF0000 };
		...
		protected void onDraw(Canvas canvas) {
			...
			canvas.drawLine(rectLeft - offset, rectTop - offset * 2, rectLeft - offset, rectBottom + offset * 2,
					mLinePaint);// 左
			canvas.drawLine(rectLeft - offset * 2, rectTop - offset, rectRight + offset * 2, rectTop - offset,
					mLinePaint);// 上
